...
- [Deploy FastAPI applications to AWS Lambda](https://aminalaee.github.io/posts/2022/fastapi-aws-lambda/) is a quick tutorial about how to deploy FastAPI and Starlette applications to AWS Lambda using Mangum, including also a suggested approach by AWS about how to manage larger applications.
